...
export default {
    ...
    async mounted() {
      axios
      .get("https://afternoon-beyond-97179.herokuapp.com/area/")
      .then((response) => (this.areaCurrent = response.data.data));
      axios
      .get("https://afternoon-beyond-97179.herokuapp.com/genre/")
        ...
        favorite: async function(item_id) {
          ...
          if(user !== null) {
            ...
            if(shop_id == 0) {
              ...
              await axios
                .post("https://afternoon-beyond-97179.herokuapp.com/favorite/",favoriteData);
